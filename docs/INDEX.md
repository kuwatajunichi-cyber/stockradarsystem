...
- [docs/contracts/signed_url_capability.md](contracts/signed_url_capability.md) — Phase 5 Track B: private R2 の committed blob へ短命 GetObject 署名（公開 mint 禁止。mint/DDL 実装済み・未マージ）
- [docs/contracts/ops_runs_views.md](contracts/ops_runs_views.md) — Phase 5 Track A 5.5b: `runs` ops SQL ビュー（画面ではない。実装済み・未マージ）
...
- Phase 5 Track B signed URL capability（mint/DDL 実装済み・未マージ）: [signed_url_capability.md](contracts/signed_url_capability.md)
- Phase 5 Track A 5.5b ops `runs` views（実装済み・未マージ）: [ops_runs_views.md](contracts/ops_runs_views.md)
