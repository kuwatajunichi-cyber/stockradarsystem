...
- [docs/contracts/signed_url_capability.md](contracts/signed_url_capability.md) — Phase 5 Track B: private R2 の committed blob へ短命 GetObject 署名（公開 mint 禁止。契約 docs マージ済。mint 未実装）
...
- Phase 5 Track B signed URL capability 契約（契約 docs マージ済。mint 未実装）: [signed_url_capability.md](contracts/signed_url_capability.md)
