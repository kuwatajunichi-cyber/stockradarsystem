...
- [docs/contracts/signed_url_capability.md](contracts/signed_url_capability.md) — Phase 5 Track B: private R2 の committed blob へ短命 GetObject 署名（公開 mint 禁止。mint/DDL マージ済・live_gate_5b closed）
- [docs/contracts/ops_runs_views.md](contracts/ops_runs_views.md) — Phase 5 Track A 5.5b: `runs` ops SQL ビュー（画面ではない。マージ済・live_gate_55b closed）
...
- Phase 5 Track B signed URL capability（mint/DDL マージ済・live_gate_5b closed。公開 mint なし）: [signed_url_capability.md](contracts/signed_url_capability.md)
