...
- [docs/contracts/signed_url_capability.md](contracts/signed_url_capability.md) — Phase 5 Track B: private R2 の committed blob へ短命 GetObject 署名（公開 mint 禁止。mint/DDL マージ済・live_gate_5b は open）
