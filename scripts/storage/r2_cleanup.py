"""
R2 上で 3 か月より古い月の成果物を削除する CLI。
--today の属する月を M0、M-1, M-2 を残し、M-3 以下を削除する（cutoff_ym より小さい YYYY-MM）。
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="R2 の 3 か月より古い成果物を削除する。")
    parser.add_argument(
        "--today",
        metavar="YYYY-MM-DD",
        default=None,
    ...
    try:
        ...
        print("R2 クリーンアップ完了", file=sys.stderr)
